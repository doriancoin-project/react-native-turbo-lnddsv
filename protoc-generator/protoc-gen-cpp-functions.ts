...
const contributorNotice = `// Note to react-native-turbo-lnddsv contributors:
...
`;
  ...
  const protobufEsWrapper = `${contributorNotice}
/* eslint-disable */
...
async function main() {
  try {
    ...
    const { cppContent, cppHeaderContent, turboSpec, protobufEsWrapper } =
